...
import { MdNotificationsNone, MdInfoOutline, MdSecurity } from 'react-icons/md';
...
export default function HeaderLinks(props) {
  ...
  console.log('NavbarLinksAdmin - propsRoutes:', propsRoutes);
  console.log('NavbarLinksAdmin - default routes:', routes);
  const { colorMode, toggleColorMode } = useColorMode();
  const { user, userName, role, canAccessSuperAdmin, canAccessBrandAdmin, signOut } = useAuth();
